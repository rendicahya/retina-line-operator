...
from methods import window_average, single_line_opr
...
def multi(path, image, mask, line_size):
    ...
    line_str = [single_line_opr.single(single_line_opr.cached_line(path, image, mask, size), window_avg, mask) for size in
